...
- user bilgileri için = (https://jsonplaceholder.typicode.com/users/1)
- post bilgileri için = (https://jsonplaceholder.typicode.com/posts?userId=1)
...
-Elimizdeki çıktı aşağıdaki gibi olmalıdır.
```
	{
		id: 1,
		name: "Leanne Graham",
